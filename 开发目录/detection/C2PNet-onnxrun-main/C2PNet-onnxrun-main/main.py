...
if __name__ == '__main__':
    ...
    for each in os.listdir(path):
        ...
        parser.add_argument('--modelpath', type=str,
                            default=r'C:\Users\Lenovo\Desktop\极端天气人体识别检测系统\system\开发目录\detection\C2PNet-onnxrun-main\C2PNet-onnxrun-main\weights\c2pnet_outdoor_640x640.onnx', help="onnx path")
