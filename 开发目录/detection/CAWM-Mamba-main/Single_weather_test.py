...
if __name__ == '__main__':
    ...
    parser.add_argument('--ir_path', default='/public/home/Feecuin1/feecuin/xiaobo_mamba/datasets/normal_fusion/M3FD/gt_ir', type=str)
    parser.add_argument('--vi_path', default='/public/home/Feecuin1/feecuin/xiaobo_mamba/datasets/normal_fusion/M3FD/gt_vi', type=str)
    # parser.add_argument('--weights_path', type=str, default='/public/home/Feecuin1/feecuin/xiaobo_mamba/checkpoint/6-5/xiaobo_mamba_1900.pth', help='initial weights path')
    parser.add_argument('--weights_path', type=str, default='/public/home/Feecuin1/feecuin/xiaobo_mamba/checkpoint/normal_fusion/M3FD/xiaobo_mamba_0100.pth', help='initial weights path')
    parser.add_argument('--save_path', type=str, default='/public/home/Feecuin1/feecuin/xiaobo_mamba/result/downstreams/Our_Seg_gt_ir', help='output save image path')
