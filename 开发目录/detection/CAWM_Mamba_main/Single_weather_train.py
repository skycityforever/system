...
def hyper_args():
    ...
    # dataset
    parser.add_argument('--ir_path', default='/public/home/Feecuin1/feecuin/xiaobo_mamba/datasets/all_weather/ir', type=str)
    parser.add_argument('--vi_path', default='/public/home/Feecuin1/feecuin/xiaobo_mamba/datasets/all_weather/vi', type=str)
    parser.add_argument('--gt_path', default='/public/home/Feecuin1/feecuin/xiaobo_mamba/datasets/all_weather/gt_vi', type=str)
    parser.add_argument('--gt_ir_path',default='/public/home/Feecuin1/feecuin/xiaobo_mamba/datasets/all_weather/gt_ir',type=str)
    # parser.add_argument('--img_size', default=[96,144,160,192] , type=int, help='裁剪图片的大小')
    parser.add_argument('--img_size', default=[128,144,192,192] , type=int, help='裁剪图片的大小')
    parser.add_argument('--batchsize', default=[7,5,3,3], type=int, help='mini-batch size')  # 32
    ...
    # checkpoint
    parser.add_argument("--load_model_fuse", default='/public/home/Feecuin1/feecuin/xiaobo_mamba/checkpoint/5-26/xiaobo_mamba_0500.pth', help="path to pretrained model (default: none)")
    parser.add_argument('--ckpt', default='/public/home/Feecuin1/feecuin/xiaobo_mamba/checkpoint/6-5', help='checkpoint cache folder')
